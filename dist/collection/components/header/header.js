  ...
  render() {
    return (h("header", { class: "font-body" },
      h("div", { class: "container mx-auto px-7 py-7 flex justify-between font-semibold" },
        ...
        h("button", { class: "md:hidden", onClick: () => { this.open = !this.open; } },
        ...
        h("div", { class: "w-full hidden justify-end items-center space-x-4 lg:flex" },
          ...
          h("a", { href: "https://vas.cx/youtube", target: "_blank", rel: "noopener" },
            h("svg", { class: "h-4 w-4 fill-current", version: "1.1", viewBox: "0 0 512 512", xmlns: "http://www.w3.org/2000/svg" },
              h("g", null,
                h("path", { d: "M501.299,132.766c-5.888,-22.03 -23.234,-39.377 -45.264,-45.264c-39.932,-10.701 -200.037,-10.701 -200.037,-10.701c0,0 -160.105,0 -200.038,10.701c-22.025,5.887 -39.376,23.234 -45.264,45.264c-10.696,39.928 -10.696,123.236 -10.696,123.236c0,0 0,83.308 10.696,123.232c5.888,22.03 23.239,39.381 45.264,45.268c39.933,10.697 200.038,10.697 200.038,10.697c0,0 160.105,0 200.037,-10.697c22.03,-5.887 39.376,-23.238 45.264,-45.268c10.701,-39.924 10.701,-123.232 10.701,-123.232c0,0 0,-83.308 -10.701,-123.236Z" }),
                h("path", { class: "text-white dark:text-gray-700 transition-colors", d: "M204.796,332.803l133.018,-76.801l-133.018,-76.801l0,153.602Z" })))),
